...
class TaskCard extends React.Component {
  ...
  onStop = (event) => {
    ...
    const columns = Object.keys(APPLICATION_CONSTANTS.TASKBOARD_COLUMNS);
    const sizePerColumn = window.innerWidth / columns.length;

    this.updateCardById({
      ...taskCard,
      status: columns[Math.floor(xPosition / sizePerColumn)],
    });
